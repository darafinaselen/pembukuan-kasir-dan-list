...
test.describe('Login Feature', () => {
  ...
  test('should display login form', async ({ page }) => {
    ...
    await expect(page.locator('text=Login ke sistem pembukuan kasir')).toBeVisible();
  ...
  test('should show error for empty fields', async ({ page }) => {
    ...
    const emailRequired = await emailInput.evaluate((el) => el.validity.valueMissing);
    const passwordRequired = await passwordInput.evaluate((el) => el.validity.valueMissing);
