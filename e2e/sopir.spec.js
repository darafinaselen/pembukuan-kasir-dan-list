...
test.describe("Sopir (Drivers) Feature", () => {
  test("should display sopir page", async ({ page }) => {
    ...
    const addButton = page.locator(
      'button:has-text("Tambah Sopir"), button:has-text("Tambah")'
    );
  ...
  test("should open add sopir dialog", async ({ page }) => {
    ...
    const addButton = page
      .locator('button:has-text("Tambah Sopir"), button:has-text("Tambah")')
      .first();
    ...
    // Check form fields
    await expect(
      page.locator('input[name="driver_name"], input[placeholder*="Nama"]')
    ).toBeVisible();
    await expect(
      page.locator('input[name="phone_number"], input[placeholder*="Telepon"]')
    ).toBeVisible();
  });
