...
test.describe('Staff Feature', () => {
  ...
  test('should display staff page', async ({ page }) => {
    ...
    const addButton = page.locator('button:has-text("Tambah Staff"), button:has-text("Tambah")');
  ...
  test('should open add staff dialog', async ({ page }) => {
    ...
    const addButton = page.locator('button:has-text("Tambah Staff"), button:has-text("Tambah")').first();
    ...
    // Check form fields
    await expect(page.locator('input[name="staff_name"], input[placeholder*="Nama"]')).toBeVisible();
    await expect(page.locator('input[name="nik"]')).toBeVisible();
    await expect(page.locator('input[name="position"], input[placeholder*="Posisi"]')).toBeVisible();
  });
